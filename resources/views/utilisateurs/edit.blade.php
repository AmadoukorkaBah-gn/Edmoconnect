...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('utilisateurs.update', $user) }}" method="POST" class="bg-white rounded-xl shadow-sm p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="mac_address" value="{{ old('mac_address', $user->mac_address) }}"
                class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
