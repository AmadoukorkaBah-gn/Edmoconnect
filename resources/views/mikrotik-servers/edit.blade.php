...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Modifier le serveur</h1>
    </div>

    <form action="{{ route('mikrotik-servers.update', $server) }}" method="POST" class="bg-white rounded-xl shadow-sm p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    Mot de passe <span class="text-gray-400 font-normal">(laisser vide pour ne pas changer)</span>
                </label>
        ...
        <div class="flex items-center space-x-6">
            <div class="flex items-center">
                <input type="checkbox" name="ssl" id="ssl" value="1" {{ old('ssl', $server->ssl) ? 'checked' : '' }}
