...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Nouveau forfait</h1>
    </div>

    <form action="{{ route('forfaits.store') }}" method="POST" class="bg-white rounded-xl shadow-sm p-8 space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="mikrotik_profile" value="{{ old('mikrotik_profile') }}"
                placeholder="ex: profile-1h"
                class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
