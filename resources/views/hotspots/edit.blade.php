...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Modifier le hotspot</h1>
    </div>

    <form action="{{ route('hotspots.update', $hotspot) }}" method="POST" class="bg-white rounded-xl shadow-sm p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <select name="mikrotik_server_id"
                ...
                @foreach ($servers as $server)
                    <option value="{{ $server->id }}" {{ old('mikrotik_server_id', $hotspot->mikrotik_server_id) == $server->id ? 'selected' : '' }}>
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name', $hotspot->name) }}"
                class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="interface" value="{{ old('interface', $hotspot->interface) }}"
                    class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="text" name="profile" value="{{ old('profile', $hotspot->profile) }}"
                    class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div>
            ...
            <input type="text" name="address" value="{{ old('address', $hotspot->address) }}"
                class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('description', $hotspot->description) }}</textarea>
            @error('description')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
        </div>

        <div class="flex items-center">
            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $hotspot->is_active) ? 'checked' : '' }}
